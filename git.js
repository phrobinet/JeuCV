function game() {
    // window.addEventListener('DOMContentLoaded', function () {
        ...
        var tab = [0, 200, 1350, 2000, 2700, 3400, 4200, 5100];
        var tabInverse = [500, 1100, 1700, 2300, 3900, 4500, 4800, 5300];
      ...
      var ConstructeurDeCrabe = function() {
        ...
        this.draw = function(x){
          ctx.drawImage(crabe, sprite.crabe[indexTab][0], sprite.crabe[indexTab][1], sprite.crabe[indexTab][2], sprite.crabe[indexTab][3], xcrabe + x, ycrabe, swcrabe, sycrabe);
        }
      }
      ...
      ctx.drawImage(levier, 0, 706, 308, 354, xLevier, 260, 130, 180);
        ...
        function gameTime(timestamp) {
            ...
            for(let i = 0 ; i<=7; i++){
              if(plafond%2== 0){
                if (aze < xcrabe + tabInverse[i] (swcrabe - 30) && aze + 90 > xcrabe && y < ycrabe + (sycrabe-30) && y + 140 > ycrabe) {die()}
              } else {
                if (aze < xcrabe + tab[i] + (swcrabe - 30) && aze + 90 > xcrabe + 500 && y < ycrabe + (sycrabe-30) && y + 140 > ycrabe) {die()}
              }
            }
